...
````{carp "162:1-192:14"}
#' @challenge Named Variables and the Scope of Variables
#' 
...
````{carp "321:1-345:14"}
#' @challenge Functions to Create Graphs
#' 
